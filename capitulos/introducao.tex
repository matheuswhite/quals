...
\item Catalogar o espaço de design e implementar as garantias impostas para tornar os data races, presentes no lado safe da fronteira, inexprimíveis;
\end{enumerate}

\begin{enumerate}
\setcounter{enumi}{3}
\item Implementar, na biblioteca Aule, um subconjunto das garantias (um por eixo do espaço de design) impostas para tornar os data races inexprimíveis;
...
\item Comparar o overhead de tempo de execução e a perda de \textit{deadlines} entre a implementação em Rust e em C de controladores que compartilham estado entre múltiplos contextos;
