...
As alternativas catalogadas são construções idiomáticas e estabelecidas. As alternativas Atomics, \texttt{Arc} e Cópia owned vêm de \citep{}; enquanto a alternativa Mutex pode ser encontrada em \citep{}; já a alternativa snapshot e publicação vem de \citep{}; a transferência de mensagens é bem fundamentada em \citep{}. Essas alternativas são representativas e não exaustivas. Foram deixadas de lado alternativas que são específicas de frameworks, como o priority-ceiling do \ac{RTOS} \ac{RTIC} \citep{}. Pois essa alternativa impediria a implementação em ambientes com outros \ac{RTOS}, como Embassy, ou em bare-metal.
