...
\begin{landscape}
  ...
  \begin{longtable}{>{\raggedright\arraybackslash}p{3cm} *{18}{c} >{\raggedright\arraybackslash\scriptsize}p{4.2cm}}
    ...
    \midrule
    \endfirsthead
    \multicolumn{20}{c}{\tablename\ \thetable{} -- continuacao} \\
    \toprule
    \textbf{Name}
      & \rotatebox{90}{embedded setpoint~}
      & \rotatebox{90}{mutable setpoint~}
    ...
    \bottomrule
    \endlastfoot
    \csvreader[respect underscore, no check column count, separator=comma, late after line=\\]%
      {res/pids.csv}{}{%
