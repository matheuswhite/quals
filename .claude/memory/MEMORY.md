...
- [Ponto de retomada](ponto_retomada.md) — Cap. 4 esqueleto reorganizado (método-por-objetivo) + 2 decisões de escopo (4/jun): só data race, planta = pêndulo invertido; próximo = redigir 4.1–4.4 no .tex
