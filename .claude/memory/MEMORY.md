...
- [Ponto de retomada](ponto_retomada.md) — Cap. 4 completo (falta passe de forma); cap. 5: §5.1 e §5.2 escritas/revisadas/**commitadas**, §5.3 (limitações) **fechada em conteúdo** (falta commit `docs:` + passe ortográfico). Refs IoC no `.bib` (commit `261c832`). Próximo = §"Bibliotecas e repositórios de controle" (`sec:control-repos`, vazia — transcrever planilha). Entrega banca 7/ago; defesa 26/ago
