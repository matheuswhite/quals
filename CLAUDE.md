...
- `capitulos/` — the seven main chapters: `introducao`, `relatedworks`, `fundamentacao`, `Metodologia_Proposta`, `Resultados_Parciais`, `Cronograma_de_Execucao`, `conclusao`. Most are skeletons with only `\section`/`\subsection` headings.
